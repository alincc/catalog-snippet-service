...
public class ContentSearchService implements IContentSearchService {
    ...
    private PageInfo extractPageInfo(Annotation annotation, String query) {
        ...
        ResponseEntity<Canvas> entity = restTemplate.getForEntity("http://catalog-iiif-presentation-service/v1/catalog/iiif/{id}/canvas/{pageid}", Canvas.class,annotation.getId(),pageId);

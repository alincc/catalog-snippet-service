...
public class ContentSearchServiceTest {
    ...
    public void whenTextFoundResultShouldNotBeEmpty() {
        ...
        a1.setOn("http://api.nb.no/catalog/v1/iiif/0b8501b8e2b822c8ec13558de82aaef9/canvas/DIV3#909,493,1346,592");
        Annotation a2 = new Annotation();
        a2.setOn("http://api.nb.no/catalog/v1/iiif/0b8501b8e2b822c8ec13558de82aaef9/canvas/DIV3#400,1657,558,1717");

...
public class SnippetControllerIT {
    ...
    public void setup() throws Exception {
        ...
        final Dispatcher dispatcher = new Dispatcher() {
            ...
            public MockResponse dispatch(RecordedRequest request) throws InterruptedException {
                if (request.getPath().equals("/catalog/v1/contentsearch/0b8501b8e2b822c8ec13558de82aaef9/search?q=publikum")) {
                    return new MockResponse().setBody(contentsearch).setHeader("Content-Type", "application/hal+json; charset=utf-8");
                }
                else if (request.getPath().startsWith("/catalog/v1/iiif/0b8501b8e2b822c8ec13558de82aaef9/canvas/DIV3")) {
                    return new MockResponse().setBody(presentation1).setHeader("Content-Type", "application/hal+json; charset=utf-8");
                }
                else if (request.getPath().equals("/catalog/v1/iiif/0b8501b8e2b822c8ec13558de82aaef9/canvas/DIV17")) {
    ...
    public void helloWorldTest() throws Exception {
        ResponseEntity<Snippet[]> responseEntity = rest.exchange("http://localhost:" + port + "/catalog/v1/snippet?id=0b8501b8e2b822c8ec13558de82aaef9&query=publikum", HttpMethod.GET,
